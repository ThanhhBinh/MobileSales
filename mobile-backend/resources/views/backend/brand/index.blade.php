                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <div class="col text-right">
                                    ...
                                    <a class="btn btn-danger" href="{{ route('admin.brand.trash') }}">
                                                            ...
                                                            <form method="GET" action="{{ route('admin.brand.index') }}"
                                                                ...
                                                                <div class="search-body">
                                                                    <div class="row px-5 mt-3">
                                                                        <!-- Trường tìm kiếm theo tên thương hiệu -->
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label
                                                                                    class="col-md-4 col-form-label text-right"
                                                                                    for="name">Tên thương hiệu:</label>
                                                                                <div class="col-md-8">
                                                                                    <input type="text"
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    @else
                                                        <div class="mb-3">
                                                            ...
                                                            <form action="{{ route('admin.brand.delete_multiple') }}"
