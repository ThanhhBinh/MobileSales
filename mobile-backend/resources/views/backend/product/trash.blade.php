                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <div class="col text-right">
                                    <a class="btn  btn-info" href="{{ route('admin.product.index') }}">
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-12 d-flex justify-content-start">
                                                    <form style=" margin-right: 10px;" id="delete-form"
                                                        action="{{ route('admin.product.destroy_multiple') }}"
                                                        method="POST">
                                                        @csrf
                                                    ...
                                                    <form style="width: 200px;" id="restore-form"
                                                        action="{{ route('admin.product.restore_multiple') }}"
                                                        method="POST">
                                                        @csrf
                                                    ...
                                                    <tbody>
                                                        @foreach ($list as $row)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    @if ($row->media_url)
                                                                        <img src="{{ asset('storage/' . $row->media_url) }}"
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('admin.product.destroy', $args) }}"
