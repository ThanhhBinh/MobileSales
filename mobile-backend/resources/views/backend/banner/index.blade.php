                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <div class="col text-right">
                                    ...
                                    <a class="btn btn-danger" href="{{ route('admin.banner.trash') }}">
                                                            ...
                                                            <form method="GET" action="{{ route('admin.banner.index') }}"
                                                                ...
                                                                <div class="search-body">
                                                                    <div class="row px-5 mt-3">
                                                                        <!-- Trường tìm kiếm theo tên banner -->
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label
                                                                                    class="col-md-4 col-form-label text-right"
                                                                                    for="name">Tên banner:</label>
                                                                                <div class="col-md-8">
                                                                                    <input type="text"
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label
                                                                                    class="col-md-4 col-form-label text-right"
                                                                                    for="position">Vị trí:</label>
                                                                                <div class="col-md-8">
                                                                                    <select class="form-control"
                                                                                        id="position" name="position">
                                                                                        <option value="">-- Chọn vị
                                                                                            trí --</option>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    @else
                                                        <div class="mb-3">
                                                            ...
                                                            <form action="{{ route('admin.banner.delete_multiple') }}"
                                                        ...
                                                        <table class="table table-bordered table-striped table-hover">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Tên banner</th>
                                                                    <th>Link</th>
                                                                    <th class="text-center" style="width:150px">Vị trí
                                                                    </th>
                                                            ...
                                                            <tbody>
                                                                @foreach ($banner as $row)
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            @if ($row->image)
                                                                                <img src="{{ asset('images/banners/' . $row->image) }}"
                                                                                    class="img-fluid"
                                                                                    alt="{{ $row->name }}">
                                                                            @else
                                                        ...
                                                        <div class="row margin-t-5 justify-content-center">
                                                            <div class="col-lg-5 col-xs-12">
                                                                <div class="float-lg-left">
                                                                    <div class="dataTables_paginate paging_simple_numbers"
                                                                        id="banner-grid_paginate">
                                                                        <ul class="pagination">
                                                                            {{-- Previous Button --}}
                                                                            <li class="paginate_button page-item {{ $banner->onFirstPage() ? 'disabled' : '' }}"
                                                                                id="banner-grid_previous">
                                                                                <a href="{{ $banner->previousPageUrl() }}"
                                                                                    aria-controls="banner-grid"
                                                                            ...
                                                                            @for ($i = 1; $i <= $banner->lastPage(); $i++)
                                                                                <li
                                                                                    class="paginate_button page-item {{ $i == $banner->currentPage() ? 'active' : '' }}">
                                                                                    <a href="{{ $banner->url($i) }}"
                                                                                        class="page-link">{{ $i }}</a>
                                                                                </li>
                                                                            @endfor
                                                                            ...
                                                                            {{-- Next Button --}}
                                                                            <li class="paginate_button page-item {{ $banner->hasMorePages() ? '' : 'disabled' }}"
                                                                                id="banner-grid_next">
                                                                                <a href="{{ $banner->nextPageUrl() }}"
                                                                                    aria-controls="banner-grid"
                                                                        ...
                                                                        <div class="dataTables_length"
                                                                            ...
                                                                            <label>Số lượng
                                                                                <select style="width:62px"
                                                                                    ...
                                                                                    <option value="7"
                                                                                        {{ $banner->perPage() == 7 ? 'selected' : '' }}>
                                                                                        7</option>
                                                                                    <option value="15"
                                                                                        {{ $banner->perPage() == 15 ? 'selected' : '' }}>
                                                                                        15</option>
                                                                                    <option value="20"
                                                                                        {{ $banner->perPage() == 20 ? 'selected' : '' }}>
                                                                                        20</option>
                                                                                    <option value="50"
                                                                                        {{ $banner->perPage() == 50 ? 'selected' : '' }}>
                                                                                        50</option>
                                                                                    <option value="100"
                                                                                        {{ $banner->perPage() == 100 ? 'selected' : '' }}>
                                                                                        100</option>
                                                                                </select> Sản phẩm
                                                                            </label>
                                                                        </div>
                                                            ...
                                                            <div class="col-lg-3 col-xs-12 mt-3">
                                                                <div class="float-lg-right text-center">
                                                                    <div class="dataTables_info" id="banner-grid_info"
                                                                        role="status" aria-live="polite">
                                                                        {{ $banner->firstItem() }} đến
                                                                        {{ $banner->lastItem() }} của
                                                                        {{ $banner->total() }} sản phẩm
                                                                    </div>
                                                                </div>
                                                            </div>
