                    ...
                    <form action="{{ route('admin.category.update', ['id' => $category->id]) }}" method="post"
                            ...
                            @if ($category->image)
                                <div class="row">
                                    <div class="col-2">
                                        ...
                                        <img id="preview" src="{{ asset('images/categorys/' . $category->image) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-control">
                                <option value="2" {{ old('status', $category->status) == 2 ? 'selected' : '' }}>Chưa
                                    xuất
                                    bản</option>
                                <option value="1" {{ old('status', $category->status) == 1 ? 'selected' : '' }}>Xuất
                                    bản
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-12 text-center">
                            <button type="submit" name="replayid" class="btn btn-success">Cập nhập danh mục</button>
                        </div>
                    </form>
                </div>
            </div>
